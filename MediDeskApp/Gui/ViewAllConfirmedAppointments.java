...
public class ViewAllConfirmedAppointments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtRquest.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jtRquest.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Pat_Ids", "Pat_Name", "OPD", "Appointment Scheduled"
            }
        ) {
    ...
    private void loadAllConfirmedAppointments() {
            try {
                    List<AppointmentPojo> list = AppointmentDao.getConfirmedAppointment(UserProfile.getUserName());
                    if(list.isEmpty()) {
                              JOptionPane.showMessageDialog(null, "There is no any confirmed appointments ! ");
                              return;
                    }
                    
                    Object[] obj;
                    
                    for(AppointmentPojo ap : list ) {
                              obj = new Object[4];
                              
                              obj[0] = ap.getPatientId();
                              obj[1] = ap.getPatName();
                              obj[2] = ap.getOpd();
                              obj[3] = ap.getDate();
